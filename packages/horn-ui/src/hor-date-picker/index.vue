<template>
  <van-popup v-model="visible" round :show="visible" position="bottom">
    <van-date-picker :modelValue="computedProps.value" title="选择日期" :columns-type="computedProps.columnsType"
      @confirm="confirm" @cancel="hide" :formatter="computedProps.formatter" :min-date="computedProps.minDate"
      :max-date="computedProps.maxDate" :filter="computedProps.filter" />
  </van-popup>
</template>
